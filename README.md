...
目前收錄 **175 個目的地、316 個區域**，幾乎涵蓋全球每一個國家，橫跨亞洲、歐洲、非洲、美洲、大洋洲：
...
熱門國家提供更多區域選擇：日本 8 區、中國 7 區、義大利 7 區、泰國／法國／西班牙／德國／英國／越南各 5-6 區。
...
驗證資料完整性：`node scripts/validate_data.mjs`（檢查 175 個目的地、316 區的欄位結構與 GeoJSON 對應）。
