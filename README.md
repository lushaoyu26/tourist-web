...
目前收錄 **175 個目的地、367 個區域**，幾乎涵蓋全球每一個國家，橫跨亞洲、歐洲、非洲、美洲、大洋洲：
...
熱門國家提供更多區域選擇：日本 8 區、中國／義大利 7 區、澳洲及泰法西德英越印馬各 5-6 區，並廣及巴西、阿根廷、土耳其、葡萄牙、埃及、摩洛哥等。
...
驗證資料完整性：`node scripts/validate_data.mjs`（檢查 175 個目的地、367 區的欄位結構與 GeoJSON 對應）。
