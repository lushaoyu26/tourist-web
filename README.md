...
- **🎲 隨機探索**：城市太多選擇困難？首頁與每個城市頁底部都有「隨機探索」按鈕，在 677 個城市裡隨機跳到一個驚喜目的地。
...
目前收錄 **175 個目的地、677 個區域**，幾乎涵蓋全球每一個國家，橫跨亞洲、歐洲、非洲、美洲、大洋洲：
...
熱門國家深度收錄：美國 17 區、日本 15 區、中國 15 區、義大利 13 區、法/德/西/英/希臘各 12 區、韓國／台灣各 12 區、泰國 11 區、越南／印度／墨西哥／巴西／加拿大各 10 區。
...
驗證資料完整性：`node scripts/validate_data.mjs`（檢查 175 個目的地、677 區的欄位結構與 GeoJSON 對應）。
