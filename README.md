...
- **🎲 隨機探索**：城市太多選擇困難？首頁與每個城市頁底部都有「隨機探索」按鈕，在 748 個城市裡隨機跳到一個驚喜目的地。
...
目前收錄 **175 個目的地、748 個區域**，幾乎涵蓋全球每一個國家，橫跨亞洲、歐洲、非洲、美洲、大洋洲：
...
熱門國家深度收錄：美國 20 區、日本 18 區、中國 18 區、義大利 16 區、法國／西班牙／印度各 15 區、泰國 14 區、德/英/希臘各 12 區、韓國／台灣各 12 區。
...
驗證資料完整性：`node scripts/validate_data.mjs`（檢查 175 個目的地、748 區的欄位結構與 GeoJSON 對應）。
