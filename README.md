...
目前收錄 **175 個目的地、435 個區域**，幾乎涵蓋全球每一個國家，橫跨亞洲、歐洲、非洲、美洲、大洋洲：
...
熱門國家深度收錄：日本 10 區、義大利 9 區、法/英/德/西/韓/台各 8 區，歐洲各國普遍 4-8 區。
...
驗證資料完整性：`node scripts/validate_data.mjs`（檢查 175 個目的地、435 區的欄位結構與 GeoJSON 對應）。
